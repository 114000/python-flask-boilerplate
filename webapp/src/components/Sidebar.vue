      ...
      <div>
        ...
        <ul class="mt-3">
          ...
          <router-link to="/team-tabs" custom v-slot="{ href, navigate }">
            <li
              class="px-3 py-2 rounded-sm mb-0.5 last:mb-0"
              :class="currentRoute.fullPath.includes('team-') && 'bg-gray-900'"
            >
              <a
                class="block text-gray-200 hover:text-white transition duration-150"
                :class="currentRoute.fullPath.includes('team-') && 'hover:text-gray-200'"
                :href="href"
                @click="navigate"
              >
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex flex-shrink-0 ml-2">
                    <svg
                      ...
                      :class="currentRoute.fullPath.includes('team-') && 'transform rotate-180'"
                      viewBox="0 0 12 12"
                    >
              ...
              <ul class="pl-9 mt-1" :class="!currentRoute.fullPath.includes('team-') && 'hidden'">
                <router-link to="/team-tabs" custom v-slot="{ href, navigate, isExactActive }">
                  <li class="mb-1 last:mb-0">
                    <a
                      class="block text-gray-200 hover:text-white transition duration-150"
                      :class="isExactActive && 'text-indigo-400 hover:text-indigo-400'"
                      :href="href"
                      @click="navigate"
                    >
